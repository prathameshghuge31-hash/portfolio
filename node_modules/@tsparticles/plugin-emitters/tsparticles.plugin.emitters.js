    ...
    class EmitterInstance {
        ...
        constructor(pluginManager, container, removeCallback, options, position) {
            ...
            if (this.options.spawn.fill?.color) {
                this.spawnFillColor = engine.rangeColorToHsl(this._pluginManager, this.options.spawn.fill.color);
            }
            if (this.options.spawn.stroke?.color) {
                this.spawnStrokeColor = engine.rangeColorToHsl(this._pluginManager, this.options.spawn.stroke.color);
            }
            this._paused = !this.options.autoPlay;
            this._particlesOptions = particlesOptions;
            this._size = this._calcSize();
            this.size = engine.getSize(this._size, this._container.canvas.size);
        ...
        resize() {
            ...
            this.position =
                initialPosition && engine.isPointInside(initialPosition, container.canvas.size, engine.Vector.origin)
                    ...
                    : this._calcPosition();
            this._size = this._calcSize();
            this.size = engine.getSize(this._size, container.canvas.size);
        ...
        _emitParticles(quantity) {
            const singleParticlesOptions = (engine.itemFromSingleOrMultiple(this._particlesOptions) ??
