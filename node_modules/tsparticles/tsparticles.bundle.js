...
(function (global, factory) {
    ...
    function addSplitParticle(pluginManager, container, parent, splitParticlesOptions) {
        ...
        const factor = identity$3 / getRangeValue(splitOptions.factor.value);
    ...
    class Dragger extends ExternalInteractorBase {
        maxDistance = 0;
        _dragStartClickTime;
        _dragStartClickingFalseTime;
        _draggedParticle;
        _grabOffset;
        _lastMousePosition;
        _momentumSamples = [];
        _mouseDownHandled = false;
        _savedVelocity;
        constructor(container) {
            super(container);
        }
        ...
        interact(interactivityData, _delta) {
            ...
            if (this._draggedParticle) {
                ...
                const hasStableClickEndWithoutClickTime = this._dragStartClickTime === undefined &&
                    this._dragStartClickingFalseTime !== undefined &&
                ...
                const targetX = pointerPos.x + (this._grabOffset?.x ?? zeroValue), targetY = pointerPos.y + (this._grabOffset?.y ?? zeroValue);
        ...
        _hasClickEnded(mouse) {
            return (this._dragStartClickTime !== undefined &&
    ...
    function bounceHorizontal(data) {
        ...
        if ((data.direction === exports.OutModeDirection.right &&
            ...
            velocity > minVelocity$6) ||
            (data.direction === exports.OutModeDirection.left && data.bounds.left <= boundsMin && velocity < minVelocity$6)) {
    ...
    function bounceVertical(data) {
        ...
        if ((data.direction === exports.OutModeDirection.bottom &&
            ...
            velocity > minVelocity$6) ||
            (data.direction === exports.OutModeDirection.top && data.bounds.top <= boundsMin && velocity < minVelocity$6)) {
    ...
    class Bubbler extends ExternalInteractorBase {
        ...
        _hoverBubbleOpacity = (particle, ratio, divBubble) => {
            ...
            const optOpacity = particle.options.opacity.value, pOpacity = particle.opacity?.value ?? defaultOpacity$1, opacity = calculateBubbleValue(pOpacity, modeOpacity, getRangeMax(optOpacity), ratio);
    ...
    class LinkInstance {
        ...
        _drawTriangles(options, p1, link, p1Destinations, pos1, pos2, context) {
            ...
            for (const vertex of p2Links) {
                ...
                const opacityTriangle = triangleOptions.opacity ?? (link.opacity + vertex.opacity) * half$1, colorTriangle = rangeColorToRgb(this._pluginManager, triangleOptions.color) ?? link.color;
    ...
    class AbsorberInstance {
        ...
        constructor(pluginManager, container, options, position) {
            ...
            this._lifeCount = this.options.life.count ?? defaultLifeCount$1;
            this._immortal = this._lifeCount <= minLifeCount$1;
        ...
        update(delta) {
            if (this._firstSpawn) {
                ...
                this._currentSpawnDelay = this._spawnDelay ?? defaultSpawnDelay$1;
            }
            if (this._duration !== undefined) {
                ...
                if (this._currentDuration >= this._duration) {
                    ...
                    if (this._lifeCount > minLifeCount$1 || this._immortal) {
        ...
        _prepareToDie = () => {
            ...
            if ((this._lifeCount > minLifeCount$1 || this._immortal) && duration !== undefined && duration > minDuration) {
        ...
        _updateParticlePosition = (particle, delta, v) => {
            ...
            if (this.options.orbits) {
                ...
                const maxSize = getRangeMax(particle.options.size.value) * container.retina.pixelRatio, sizeFactor = particle.options.move.size ? particle.getRadius() / maxSize : identity$3, deltaFactor = delta.factor || identity$3, baseSpeed = particle.retina.moveSpeed, moveSpeed = baseSpeed * sizeFactor * deltaFactor * half$1;
        ...
        play = () => {
            if (!((this._lifeCount > minLifeCount$1 || this._immortal || !this.options.life.count) &&
                (this._firstSpawn || this._currentSpawnDelay >= (this._spawnDelay ?? defaultSpawnDelay$1)))) {
                return;
            }
            if (this._lifeCount > minLifeCount$1 || this._immortal) {
                this._prepareToDie();
